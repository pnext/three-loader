  ...
  (() => {
    ...
    var e = {
        ...
        146: (t, e, n) => {
          ...
          function o() {
            return r()(
              '(()=>{"use strict";const r={DATA_TYPE_DOUBLE:{ordinal:0,name:"double",size:8},DATA_TYPE_FLOAT:{ordinal:1,name:"float",size:4},DATA_TYPE_INT8:{ordinal:2,name:"int8",size:1},DATA_TYPE_UINT8:{ordinal:3,name:"uint8",size:1},DATA_TYPE_INT16:{ordinal:4,name:"int16",size:2},DATA_TYPE_UINT16:{ordinal:5,name:"uint16",size:2},DATA_TYPE_INT32:{ordinal:6,name:"int32",size:4},DATA_TYPE_UINT32:{ordinal:7,name:"uint32",size:4},DATA_TYPE_INT64:{ordinal:8,name:"int64",size:8},DATA_TYPE_UINT64:{ordinal:9,name:"uint64",size:8}};let t=0;for(const e in r)r[t]=r[e],t++;class e{constructor(r,t,e,n=[1/0,-1/0],a=void 0){this.name=r,this.type=t,this.numElements=e,this.range=n,this.uri=a,this.byteSize=this.numElements*this.type.size,this.description=""}}function n(r){throw new TypeError(\'"\'+r+\'" is read-only\')}function a(r,t){var e="undefined"!=typeof Symbol&&r[Symbol.iterator]||r["@@iterator"];if(!e){if(Array.isArray(r)||(e=function(r,t){if(r){if("string"==typeof r)return i(r,t);var e={}.toString.call(r).slice(8,-1);return"Object"===e&&r.constructor&&(e=r.constructor.name),"Map"===e||"Set"===e?Array.from(r):"Arguments"===e||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(e)?i(r,t):void 0}}(r))||t&&r&&"number"==typeof r.length){e&&(r=e);var n=0,a=function(){};return{s:a,n:function(){return n>=r.length?{done:!0}:{done:!1,value:r[n++]}},e:function(r){throw r},f:a}}throw new TypeError("Invalid attempt to iterate non-iterable instance.\\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.")}var o,A=!0,f=!1;return{s:function(){e=e.call(r)},n:function(){var r=e.next();return A=r.done,r},e:function(r){f=!0,o=r},f:function(){try{A||null==e.return||e.return()}finally{if(f)throw o}}}}function i(r,t){(null==t||t>r.length)&&(t=r.length);for(var e=0,n=Array(t);e<t;e++)n[e]=r[e];return n}new e("POSITION_CARTESIAN",r.DATA_TYPE_FLOAT,3),new e("COLOR_PACKED",r.DATA_TYPE_INT8,4),new e("COLOR_PACKED",r.DATA_TYPE_INT8,4),new e("COLOR_PACKED",r.DATA_TYPE_INT8,3),new e("NORMAL_FLOATS",r.DATA_TYPE_FLOAT,3),new e("INTENSITY",r.DATA_TYPE_UINT16,1),new e("CLASSIFICATION",r.DATA_TYPE_UINT8,1),new e("NORMAL_SPHEREMAPPED",r.DATA_TYPE_UINT8,2),new e("NORMAL_OCT16",r.DATA_TYPE_UINT8,2),new e("NORMAL",r.DATA_TYPE_FLOAT,3),new e("RETURN_NUMBER",r.DATA_TYPE_UINT8,1),new e("NUMBER_OF_RETURNS",r.DATA_TYPE_UINT8,1),new e("SOURCE_ID",r.DATA_TYPE_UINT16,1),new e("INDICES",r.DATA_TYPE_UINT32,1),new e("SPACING",r.DATA_TYPE_FLOAT,1),new e("GPS_TIME",r.DATA_TYPE_DOUBLE,1),Int8Array,Int16Array,Int32Array,Float64Array,Uint8Array,Uint16Array,Uint32Array,Float64Array,Float32Array,Float64Array,onmessage=function(t){var i,o,A,f=t.data,_=f.buffer,u=f.pointAttributes,s=(f.scale,f.name,f.min),T=(f.max,f.size),l=f.offset,I=f.numPoints,y=f.harmonicsEnabled,b=new DataView(_),w={},N=32,h=new Uint32Array(Math.pow(N,3)),E=function(r,t,e){var n=N*r/T.x,a=N*t/T.y,i=N*e/T.z,o=Math.min(parseInt(n),31),A=Math.min(parseInt(a),31),f=Math.min(parseInt(i),31);return o+A*N+f*N*N},m=function(r,t,e){return Math.max(Math.min(r,e),t)},c=0,d=[Number.POSITIVE_INFINITY,Number.POSITIVE_INFINITY,Number.POSITIVE_INFINITY],v=[Number.NEGATIVE_INFINITY,Number.NEGATIVE_INFINITY,Number.NEGATIVE_INFINITY],O=new ArrayBuffer(4*I*4),p=new Float32Array(O),P=new ArrayBuffer(4*I*4),M=new Float32Array(P),D=new ArrayBuffer(4*I*3),U=new Float32Array(D),F=new ArrayBuffer(4*I*4),S=new Float32Array(F),Y=new ArrayBuffer(4*I*4),C=new Float32Array(Y),x=new ArrayBuffer(45*I*4),R=new Float32Array(x),z=(i=new Float32Array(1),o=new Int32Array(i.buffer),function(r){return i[0]=r,o[0]}),g=["sh_band_1_triplet_0","sh_band_1_triplet_1","sh_band_1_triplet_2","sh_band_2_triplet_0","sh_band_2_triplet_1","sh_band_2_triplet_2","sh_band_2_triplet_3","sh_band_2_triplet_4","sh_band_3_triplet_0","sh_band_3_triplet_1","sh_band_3_triplet_2","sh_band_3_triplet_3","sh_band_3_triplet_4","sh_band_3_triplet_5","sh_band_3_triplet_6"],B=a(u.attributes);try{for(B.s();!(A=B.n()).done;){var L=A.value;if(["POSITION_CARTESIAN","position"].includes(L.name)){for(var V=l[0]-s.x,H=l[1]-s.y,G=l[2]-s.z,k=0;k<I;k++){var K=12*k,j=b.getFloat32(K+0,!0),q=b.getFloat32(K+4,!0),Q=b.getFloat32(K+8,!0),$=j+V,J=q+H,W=Q+G;d[0]=Math.min(d[0],$),d[1]=Math.min(d[1],J),d[2]=Math.min(d[2],W),v[0]=Math.max(v[0],$),v[1]=Math.max(v[1],J),v[2]=Math.max(v[2],W),0===h[E($,J,W)]++&&c++,p[4*k+0]=$,p[4*k+1]=J,p[4*k+2]=W,M[4*k+0]=j,M[4*k+1]=q,M[4*k+2]=Q}w.raw_position={buffer:P,attribute:"raw_position"},w.position={buffer:O,attribute:"position"}}else if(["sh_band_0"].includes(L.name))for(var X=.28209479177387814,Z=12*I,rr=15*I,tr=0;tr<I;tr++){var er=4*tr+0,nr=4*tr+1,ar=4*tr+2,ir=4*tr+3,or=3*tr+Z,Ar=1*tr+rr,fr=(b.getUint8(or+0,!0)/255-.5)/.15,_r=(b.getUint8(or+1,!0)/255-.5)/.15,ur=(b.getUint8(or+2,!0)/255-.5)/.15;C[er]=255*(.5+X*fr),C[nr]=255*(.5+X*_r),C[ar]=255*(.5+X*ur),C[er]=m(Math.floor(C[er]),0,255),C[nr]=m(Math.floor(C[nr]),0,255),C[ar]=m(Math.floor(C[ar]),0,255);var sr=b.getUint8(Ar,!0);sr=m(sr,0,255),C[ir]=sr}else if(["scale"].includes(L.name)){for(var Tr=16*I,lr=0;lr<I;lr++){var Ir=8*lr+Tr,yr=b.getFloat32(Ir+0,!0),br=b.getFloat32(Ir+4,!0);U[3*lr+0]=Math.exp(yr),U[3*lr+1]=Math.exp(br),U[3*lr+2]=0}w.scale={buffer:D,attribute:"scale"}}else if(["rotation"].includes(L.name)){for(var wr=24*I,Nr=function(){var r=4*hr+wr,t=b.getUint32(r,!0),e=function(r){return(1-2*(t>>r+9&1))*(t>>r&511)/(511*Math.SQRT2)},n=t>>30&3,a=e(20),i=e(10),o=e(0),A=Math.sqrt(1-a*a-i*i-o*o),f=0,_=0,u=0,s=1;switch(n){case 0:f=A,_=a,u=i,s=o;break;case 1:f=a,_=A,u=i,s=o;break;case 2:f=a,_=i,u=A,s=o;break;case 3:f=a,_=i,u=o,s=A}S[4*hr+0]=f,S[4*hr+1]=_,S[4*hr+2]=u,S[4*hr+3]=s},hr=0;hr<I;hr++)Nr();w.orientation={buffer:F,attribute:"orientation"}}else if(L.name.indexOf("triplet")>-1&&y)for(var Er=g.indexOf(L.name),mr=I*(28+3*Er),cr=0;cr<I;cr++){var dr=3*cr+mr,vr=(b.getUint8(dr+0,!0)-128)/128,Or=(b.getUint8(dr+1,!0)-128)/128,pr=(b.getUint8(dr+2,!0)-128)/128;R[45*cr+3*Er+0]=vr,R[45*cr+3*Er+1]=Or,R[45*cr+3*Er+2]=pr}}}catch(r){B.e(r)}finally{B.f()}for(var Pr=function(r,t,e){var n=function(r,t){var e=new Array(16),n=r.x,a=r.y,i=r.z,o=r.w,A=n+n,f=a+a,_=i+i,u=n*A,s=n*f,T=n*_,l=a*f,I=a*_,y=i*_,b=o*A,w=o*f,N=o*_,h=t.x,E=t.y;e[0]=(1-(l+y))*h,e[1]=(s+N)*h,e[2]=(T-w)*h,e[3]=(s-N)*E,e[4]=(1-(u+y))*E,e[5]=(I+b)*E,e[6]=0,e[7]=0,e[8]=0;var m,c,d,v,O,p,P,M,D,U,F,S,Y,C,x,R,z,g,B,L,V,H,G=e.map(function(r){return r}),k=G;return m=k[1],k[1]=k[3],k[3]=m,m=k[2],k[2]=k[6],k[6]=m,m=k[5],k[5]=k[7],k[7]=m,c=e,d=G,v=new Array(9),O=c[0],p=c[3],P=c[6],M=c[1],D=c[4],U=c[7],F=c[2],S=c[5],Y=c[8],C=d[0],x=d[3],R=d[6],z=d[1],g=d[4],B=d[7],L=d[2],V=d[5],H=d[8],v[0]=O*C+p*z+P*L,v[3]=O*x+p*g+P*V,v[6]=O*R+p*B+P*H,v[1]=M*C+D*z+U*L,v[4]=M*x+D*g+U*V,v[7]=M*R+D*B+U*H,v[2]=F*C+S*z+Y*L,v[5]=F*x+S*g+Y*V,v[8]=F*R+S*B+Y*H,v}(t,r);Dr[4*e+0]=n[0],Dr[4*e+1]=n[3],Dr[4*e+2]=n[6],Dr[4*e+3]=n[4],Fr[2*e+0]=n[7],Fr[2*e+1]=n[8]},Mr=new ArrayBuffer(4*I*4),Dr=new Float32Array(Mr),Ur=new ArrayBuffer(4*I*2),Fr=new Float32Array(Ur),Sr=0;Sr<I;Sr++){var Yr={x:0,y:0,z:0,w:0},Cr={x:0,y:0,z:0};Yr.w=S[4*Sr+0],Yr.x=S[4*Sr+1],Yr.y=S[4*Sr+2],Yr.z=S[4*Sr+3],Cr.x=U[3*Sr+0],Cr.y=U[3*Sr+1],Cr.z=U[3*Sr+2],Pr(Cr,Yr,Sr)}w.COVARIANCE0={buffer:Mr,attribute:e.COVARIANCE0},w.COVARIANCE1={buffer:Ur,attribute:e.COVARIANCE1};for(var xr=function(r){return r[0]+(r[1]<<8)+(r[2]<<16)+(r[3]<<24)},Rr=new ArrayBuffer(4*I*4),zr=new Int32Array(Rr),gr=0;gr<I;gr++){var Br={x:0,y:0,z:0,w:0},Lr={x:0,y:0,z:0};Br.x=C[4*gr+0],Br.y=C[4*gr+1],Br.z=C[4*gr+2],Br.w=C[4*gr+3],Lr.x=M[4*gr+0],Lr.y=M[4*gr+1],Lr.z=M[4*gr+2];var Vr=xr([Br.x,Br.y,Br.z,Br.w]);Lr.x=z(Lr.x),Lr.y=z(Lr.y),Lr.z=z(Lr.z),zr[4*gr+0]=Vr,zr[4*gr+1]=Lr.x,zr[4*gr+2]=Lr.y,zr[4*gr+3]=Lr.z}w.POS_COLOR={buffer:Rr,attribute:e.POS_COLOR};var Hr=new ArrayBuffer(4*I*3),Gr=new Uint32Array(Hr),kr=new ArrayBuffer(4*I*5),Kr=new Uint32Array(kr),jr=new ArrayBuffer(4*I*7),qr=new Uint32Array(jr);R=R.map(function(r,t){r=.5*(r=Math.min(Math.max(r,-1),1))+.5;var e=t%3==1?1023:2047;return Math.min(Math.max(Math.floor(r*e),0),e)});for(var Qr=0;Qr<I;Qr++)for(var $r=0;$r<15;$r++){var Jr=R[45*Qr+3*$r+0],Wr=R[45*Qr+3*$r+1],Xr=R[45*Qr+3*$r+2];$r<3&&(Gr[3*Qr+$r-0]=Jr<<21|Wr<<11|Xr),$r>=3&&$r<8&&(Kr[5*Qr+$r-3]=Jr<<21|Wr<<11|Xr),$r>=8&&(qr[7*Qr+$r-8]=Jr<<21|Wr<<11|Xr)}w.HARMONICS1={buffer:Hr,attribute:"HARMONICS1"},w.HARMONICS2={buffer:kr,attribute:"HARMONICS2"},w.HARMONICS3={buffer:jr,attribute:"HARMONICS3"};for(var Zr=parseInt(I/c),rt=new ArrayBuffer(4*I),tt=new Uint32Array(rt),et=0;et<I;et++)tt[et]=et;w.INDICES={buffer:rt,attribute:e.INDICES};var nt,at=a(u.vectors);try{for(at.s();!(nt=at.n()).done;){var it,ot=nt.value,At=ot.name,ft=ot.attributes,_t=ft.length,ut=new ArrayBuffer(_t*I*4),st=new Float32Array(ut),Tt=a(ft);try{for(Tt.s();!(it=Tt.n()).done;){for(var lt=w[it.value],It=lt.offset,yt=lt.scale,bt=new DataView(lt.buffer),wt=bt.getFloat32.bind(bt),Nt=0;Nt<I;Nt++){var ht=wt(4*Nt,!0);st[Nt*_t+0]=ht/yt+It}n("iElement")}}catch(r){Tt.e(r)}finally{Tt.f()}var Et=new e(At,r.DATA_TYPE_FLOAT,3);w[At]={buffer:ut,attribute:Et}}}catch(r){at.e(r)}finally{at.f()}var mt={buffer:_,attributeBuffers:w,density:Zr,tightBoundingBox:{min:d,max:v}},ct=[];for(var dt in mt.attributeBuffers)ct.push(mt.attributeBuffers[dt].buffer);ct.push(_),postMessage(mt,ct)}})();\n',
              'Worker',
              void 0,
              void 0,
            );
